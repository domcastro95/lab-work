...
# download the data
wget -O canid_occ_v2.csv "https://paleobiodb.org/data1.2/occs/list.csv?base_name=Canidae&show=acconly"
...
Rscript process_canid_data_v2.R
...
python ~/PyRate/PyRate.py canid_occ_PyRate.py -data_info > data_summary_v2.txt
